...
\titlepagefigure{base_figures/placeholder.png} %path to optional title figure
\titlepagecaption{Titlepage caption.}
\titlepagecaptionfigure{} %path to optional caption figure
...
\booltrue{secret} %remove for Klassificering: Allmän
\keywords{Keywords}
\misc{Misc}
\makeatother
